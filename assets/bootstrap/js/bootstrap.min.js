      ...
      modifiers: {
              ...
              h = {
                ...
                secondary: function (t) {
                  var n = "right" === t ? "left" : "top",
                    i = u[n];
                  return (
                    u[t] > l[t] && !e.escapeWithReference && (i = Math.min(u[n], l[t] - ("right" === t ? u.width : u.height))), z({}, n, i)
                  );
                },
              };
            return (
        ...
        inner: {
          ...
          fn: function (t) {
            ...
            return (
              (o[s ? "left" : "top"] = r[n] - (a ? o[s ? "width" : "height"] : 0)), (t.placement = st(e)), (t.offsets.popper = K(o)), t
            );
          },
        },
        hide: {
  ...
  var It = "dropdown",
    ...
    Ft = (function () {
      ...
      return (
        ...
        (n.show = function (n) {
          if (
            (void 0 === n && (n = !1), !(this._element.disabled || e(this._element).hasClass("disabled") || e(this._menu).hasClass("show")))
          ) {
              ...
              if (!this._inNavbar && n) {
                ...
                "parent" === this._config.reference
                  ...
                  : l.isElement(this._config.reference) &&
                    ((s = this._config.reference), "undefined" != typeof this._config.reference.jquery && (s = this._config.reference[0])),
      ...
      return (
        ...
        (n._getConfig = function (t) {
          ...
          return (
            ...
            "number" == typeof (t = s(s(s({}, this.constructor.Default), n), "object" == typeof t && t ? t : {})).delay &&
